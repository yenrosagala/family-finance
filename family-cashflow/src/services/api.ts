...
// In a standalone build (no Metro) there is no hostUri, so the API base MUST
// come from EXPO_PUBLIC_API_URL (inlined at build time, e.g. https://api...).
// Falls back to Metro host parsing for dev, then localhost.
const API_PORT = 4000;
